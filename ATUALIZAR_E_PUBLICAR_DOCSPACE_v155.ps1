...
$Css = Get-Content -Raw (Join-Path $FrontendProjeto "lovable-original.css")
if ($Css -notmatch "DocSpace v155 — interface compacta") { Falhar "A correção de compactação não foi instalada." }
